...
import 'package:bidcare/widgets/card_galang_dana_builder,.dart';
...
class _LihatGalangState extends State<LihatGalang> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<List<Galang>> fetchGalangByUser() async {
      final response =
          await request.get('https://bidcare.up.railway.app/get_galang2/json/');
      // print(response);
            ...
            if (snapshot.data == null) {
              ...
              if (snapshot.data.length == 0) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (_, index) =>
                      cardGalangDanaBuilder(context, snapshot, index),
                );
              }
            }
          },
                  ...
                  Center(
                    child: Padding(
                      ...
                      child: DefaultTextStyle(
                        ...
                        child: Text("${snapshot.data?[index].fields.judul}"),
                      ),
                    ),
                  ),
                  Center(
